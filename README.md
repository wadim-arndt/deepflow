...
Take command of the flight with these interactive controls:

### 🐭 Mouse
- **Steer / Bend**: Move the cursor to physically bend the tunnel and change your flight path.
...
- **HTML5 Canvas API**: Pure 2D canvas utilized for 3D projection and high-frequency rendering.
- **Vanilla JavaScript (ES6+)**: Zero external dependencies or frameworks (No Three.js, No React).
- **CSS3**: minimalist styling with full-screen optimization and deep black background.
- **Performance**: Optimized for 60fps rendering across modern browsers.
